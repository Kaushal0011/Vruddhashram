...
class getImages {
  ...
  factory getImages.fromJson(Map<String, dynamic> json) {
    return getImages(
      ...
      image: "http://" +
          ip +
          "/application/Imgs Trust/esstimed_guest/" +
          json['image'],
    );
  }

  static Future<String> getJsonEndpoint() async {
    var url = "http://" + ip + "/application/eg.php";
...
class EsteemedGuest extends StatelessWidget {
  const EsteemedGuest({Key? key}) : super(key: key);

  Future<List<getImages>> downloadJSON() async {
    String jsonEndpoint = "http://" + ip + "/application/eg.php/getImage";
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Esteemed Guest'),
          ),
